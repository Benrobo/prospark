...
const scaffoldQuestions = [
  ...
  },
  {
    ...
    prefix: chalk.greenBright("\n?"),
    choices: ["Vanilla", "React", "Nextjs", "Svelte"],
  ...
  },
  {
    ...
    prefix: chalk.greenBright("\n?"),
    choices: ["css module", "tailwindcss"],
    when: (answers: any) => answers.stack === "frontend",
  },
  {
    type: "list",
    ...
    prefix: chalk.greenBright("\n?"),
    choices: ["Nextjs", "Nodejs/Express"],
    when: (answers: any) =>
      (answers.stack === "backend" || answers.stack === "fullstack") &&
      answers.variant === "Typescript",
  },
  {
    type: "list",
    name: "backendPreset",
